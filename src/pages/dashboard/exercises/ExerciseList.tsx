...
import { Dumbbell, Activity, Target, BarChart3, Edit } from 'lucide-react';
...
const ExerciseList: React.FC = () => {
  ...
  const formatMuscleType = (tipo_musculo: string) => {
    return (
      <span className="bg-blue-600/20 text-blue-400 px-3 py-1 rounded-full text-xs font-bold border border-blue-600/30 capitalize">
        {tipo_musculo}
      </span>
    );
  };
  ...
  return (
    ...
    ">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h1 className="text-2xl font-black text-dashboard-text">EJERCICIOS</h1>
      </div>
                ...
                <tbody className="divide-y divide-dashboard-accent/20">
                  {exercises.map(exercise => (
                    ...
                    >
                      ...
                      ">
                        <div className="flex items-center gap-2">
                          <Dumbbell size={14} className="text-red-400 group-hover:text-red-300" />
                          {exercise.nombre}
                        </div>
                      </td>
                      <td className="
                        px-3 py-4 sm:px-4 sm:py-4 text-xs sm:text-sm 
