// roshi_fit/src/pages/dashboard/categories/EditCategoryModal.tsx
...
const EditCategoryModal: React.FC<EditCategoryModalProps> = ({ categoryId, onClose, onUpdate }) => {
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
        <div className="bg-black p-8 rounded-2xl w-full max-w-md border-2 border-dashboard-accent/50">
          <div className="flex justify-center items-center gap-3">
            ...
            <p className="text-dashboard-text font-semibold">Cargando categoría...</p>
          </div>
        </div>
      </div>
    );
      ...
      >
        ...
        <div className="flex justify-between items-center mb-6 pb-4 border-b border-dashboard-accent/50">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-xl font-black text-dashboard-text">EDITAR CATEGORÍA</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full p-4 bg-dashboard-bg text-dashboard-text rounded-xl border-2 border-dashboard-accent/50 focus:border-green-500 focus:ring-2 focus:ring-green-500/20 hover:border-green-400/50 transition-all duration-300"
              placeholder="Ej: Proteínas, Ropa, etc."
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              rows={3}
              className="w-full p-4 bg-dashboard-bg text-dashboard-text rounded-xl border-2 border-dashboard-accent/50 focus:border-green-500 focus:ring-2 focus:ring-green-500/20 hover:border-green-400/50 transition-all duration-300 resize-none"
          ...
          <div>
            ...
            <select
              ...
              onChange={handleChange}
              className="bg-black w-full p-4 bg-dashboard-bg text-dashboard-text rounded-xl border-2 border-dashboard-accent/50 focus:border-green-500 focus:ring-2 focus:ring-green-500/20 hover:border-green-400/50 transition-all duration-300 cursor-pointer"
            >
